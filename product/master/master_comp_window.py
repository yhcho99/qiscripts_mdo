...
from qraft_data.util import get_kirin_api, ff_description_list
...
from strategy_simulation.helper import picks, weights
...
CACHE_PATH = "master_test_cache"
DATASET_PATH = "master_test_dataset"
FF_CACHE_PATH = "master_test_ff_cache"
FF_DATASET_PATH = "master_test_ff_dataset"

# remove_folders([CACHE_PATH, DATASET_PATH, FF_CACHE_PATH, FF_DATASET_PATH])

IDENTIFIER = f"master_test_window{TRAINING_LENGTH}_component{COMPONENT}"
print(f"=======\n{IDENTIFIER}\n======")
# input("Right?")
...
desc_list = ff_description_list()
desc_list = [e for e in desc_list if e.startswith("masters")]
desc_list.sort()
desc = desc_list[-2]
...
factorfactory_dict = {
    ...
    "description": desc,  # "masters_v20210731",
    "metrics": [
        "executability",
        "profitability",
        "robustness",
    ...
    "num_factors": 1,
    "kirin_cache_dir": (Path(DATA_DIR) / FF_CACHE_PATH).as_posix(),
    "factor_save_path": (Path(DATA_DIR) / FF_DATASET_PATH).as_posix(),  # DGX-v2
}
...
if __name__ == "__main__":
    ...
    ffmanager.prepare_is_checked()
    #     ffmanager.prepare_experiment()
    ...
    dates_inference = [
        #         pd.Timestamp('2002-01-31').to_pydatetime(),
        #         pd.Timestamp('2002-11-30').to_pydatetime(),
        #         pd.Timestamp('2003-11-30').to_pydatetime(),
        #         pd.Timestamp('2007-01-31').to_pydatetime(),
        #         pd.Timestamp('2007-12-31').to_pydatetime(),
        #         pd.Timestamp('2008-06-30').to_pydatetime(),
        #         pd.Timestamp('2008-09-30').to_pydatetime(),
        #         pd.Timestamp('2008-10-31').to_pydatetime(),
        #         pd.Timestamp('2009-01-31').to_pydatetime(),
        #         pd.Timestamp('2009-07-31').to_pydatetime(),
        #         pd.Timestamp('2010-03-31').to_pydatetime(),
        #         pd.Timestamp('2010-10-31').to_pydatetime(),
        pd.Timestamp('2012-02-29').to_pydatetime(),
        pd.Timestamp('2012-11-30').to_pydatetime(),
        #         pd.Timestamp('2014-03-31').to_pydatetime(),
        #         pd.Timestamp('2014-08-31').to_pydatetime(),
        #         pd.Timestamp('2014-12-31').to_pydatetime(),
        #         pd.Timestamp('2017-02-28').to_pydatetime(),
        #         pd.Timestamp('2017-04-30').to_pydatetime(),
        #         pd.Timestamp('2018-06-30').to_pydatetime(),
        #         pd.Timestamp('2019-03-31').to_pydatetime(),
        #         pd.Timestamp('2019-06-30').to_pydatetime(),
        #         pd.Timestamp('2019-08-31').to_pydatetime(),
        #         pd.Timestamp('2019-09-30').to_pydatetime(),
        #         pd.Timestamp('2019-10-31').to_pydatetime(),
        #         pd.Timestamp('2019-11-30').to_pydatetime(),
        #         pd.Timestamp('2021-10-31').to_pydatetime(),
    ]
    ...
    st = Strategy(
        ...
        long_picking_config=picks.component_picking(0.9999),
        long_weighting_config=weights.market_tilting_weight(0.5),
