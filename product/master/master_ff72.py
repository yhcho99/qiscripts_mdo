...
CACHE_PATH = "master_ff72_cache"
DATASET_PATH = "master_ff72_dataset"
FF_CACHE_PATH = "master_ff_ff72_cache"
FF_DATASET_PATH = "master_ff_ff72_live"

# remove_folders([CACHE_PATH, DATASET_PATH, FF_CACHE_PATH, FF_DATASET_PATH])

IDENTIFIER = "master-ff72-comp8"
...
def existing_dates():
    infer_dir = Path(DATA_DIR) / IDENTIFIER / "infer"
    dates = [e.stem[-10:] for e in infer_dir.iterdir() if e.suffix == ".csv"]
...
#     ffmanager.prepare_experiment()
    ...
    for d_inference in dates_inference:
        if d_inference in EXISTING_DATES:
            continue
