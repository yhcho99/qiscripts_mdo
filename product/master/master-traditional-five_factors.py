...
ROOT = "master_test_5factors"
IDENTIFIER = ROOT + f"_{year}years"
...
if __name__ == "__main__":
    ...
    momentum = five_loader.call_if_not_loaded("momentum")
    value = five_loader.call_if_not_loaded("value")
    size = five_loader.call_if_not_loaded("size")
    quality = five_loader.call_if_not_loaded("quality")
    low_vol = five_loader.call_if_not_loaded("low_vol")
