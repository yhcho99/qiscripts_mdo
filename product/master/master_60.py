...
CACHE_PATH = "master_cache60"
DATASET_PATH = "master_dataset60"
FF_CACHE_PATH = "master_ff_cache60"
FF_DATASET_PATH = "master_ff60"

# remove_folders([CACHE_PATH, DATASET_PATH, FF_CACHE_PATH, FF_DATASET_PATH])

IDENTIFIER = "master_numbers"
...
if __name__ == "__main__":
    ...
    dates_inference = [
        pd.Timestamp('2007-07-31').to_pydatetime(),
        pd.Timestamp('2008-01-31').to_pydatetime(),
        pd.Timestamp('2008-11-30').to_pydatetime(),
        pd.Timestamp('2009-10-31').to_pydatetime(),
        pd.Timestamp('2010-05-31').to_pydatetime(),
        pd.Timestamp('2013-04-30').to_pydatetime(),
        pd.Timestamp('2015-04-30').to_pydatetime(),
        pd.Timestamp('2016-05-31').to_pydatetime(),
        pd.Timestamp('2016-11-30').to_pydatetime(),
        pd.Timestamp('2019-09-30').to_pydatetime(),
        pd.Timestamp('2021-03-31').to_pydatetime(),
    ]
