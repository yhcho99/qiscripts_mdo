...
if __name__ == "__main__":
    ...
    # mom_12m_1m = load_dataset.call_if_not_loaded("mom_12m_1m", ["high_level", "equity", "get_mom"],
    #                                              ["pi", 12, 1]).masked_by(filter_mv)
    # gpa = gpa.zscore()
    ...
    cp = Comparison(
        ...
        identifier=setting_params['identifier'],
        kirin_config=setting_params['kirin_config'],
        performance_fps=list(st.get_performance_fps())+['QRFT_TH','QRFT_amom','AMOM'],
        performance_names=list(st.get_performance_names())+['QRFT_TH','QRFT_amom','AMOM'],
