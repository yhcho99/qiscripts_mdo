...
neptune_dict = {
    ...
    "exp_name": "fortech0528",  # 실험의 이름 필수는 아닙니다
    "description": "fortech0528",  # 실험의 설명 필수는 아닙니다
    "hparams": {
        **strategy_dict
...
factorfactory_dict = {
    ...
    "cache_dir": "/raid/sr-storage/ff_factors_mixweight",  # DGX-v2
...
#     )
    ...
    print("infer filter", infer_filter_base.data.columns)
