...
setting_params = {
    "identifier": "master_qrft_weighting_mw50_ew50",  # 실험의 이름입니다
    "kirin_config": {
...
strategy_dict = {
    ...
    "short_amount": 0.0,  # short포트폴리오의 총 비중입니다. ex) longonly 의 경우 0. , 130/30의 경우 -0.3
...
if __name__ == "__main__":
    ...
    for d_inference in dates_inference:
        ...
        qrft_running(name_list, lc_list, shapes_dict, d_inference)
        # proc = mp.Process(target=qrft_running, args=(name_list, lc_list, shapes_dict, d_inference))
        # proc.start()
