...
#     y = load_dataset.call_if_not_loaded("tr_1m_0m", ["high_level", "equity", "get_monthly_total_return"], [1, 0])
    y = load_dataset.call_if_not_loaded("pr_1m_0m", ["high_level", "equity", "get_monthly_price_return"], [1, 0])
    ...
    dates_inference = [
        datetime(1999, 11, 30), datetime(2003, 8, 31), datetime(2007, 10, 31), 
        datetime(2008, 5, 31), datetime(2008, 10, 31), datetime(2019, 4, 30), 
    ]
#     ] + pd.date_range("2016-04-30", "2021-04-30", freq="M").to_pydatetime().tolist()
