...
if __name__ == "__main__":
    ...
    comparison_dict["performance_fps"] = [p_pfs_list[0]]
    comparison_dict["performance_names"] = [p_names_list[0]]

    neptune_dict["tags"] = [NEPTUNE_IDENTIFIER] + [INFER_LIST[0]]
    comparison_dict["standard_benchmarks"] = UNIVERSE_LIST[2*0:2*(0+1)]
