...
#################################### 공통설정부분 ##########################################
setting_params = {
    "identifier": "Plain_Vanilla_AMOM_test03",  # 실험의 이름입니다
    "kirin_config": {
...
if __name__ == "__main__":
    ...
    v = gpa + mom_12m_1m
    filter_infer = v.rank(ascending=False, pct=False) <= 200
    ...
    st = Strategy(
        ...
        long_picking_config = picks.picking_by_signal("mu", False, 1, 100, ascending=False),
