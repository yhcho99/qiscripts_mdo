...
#################################### 공통설정부분 ##########################################
setting_params = {
    "identifier": f"BTS_model_{MODEL}_NVQ{int(NVQ_CF*100):2d}_AMOM{int(AMOM_CF*100):2d}_MV{MV_MASK}_FILTER{MASK}_long",  # 실험의 이름입니다
    "kirin_config": {
...
if __name__ == "__main__":
    ...
    norm_amom_filter = (norm_gpa + norm_mom_12m_1m).zscore()

    #BTS필터
    bts_filter = NVQ_CF * norm_index_linear_intangible_to_tangible + AMOM_CF * norm_amom_filter
