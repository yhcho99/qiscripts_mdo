...
IDENTIFIER = [
    "qrft0512_test_no_filter",
    "qrft0512_test_filter_etm",
    "qrft0512_test_filter_gpa2",
    "qrft0512_test_filter_gpa_etm",
    "qrft0512_test_filter_mixin",
    "qrft0512_test_filter_vol",
]
i = 0


setting_params = {
    "identifier": IDENTIFIER[i],  # 실험의 이름입니다
    "kirin_config": {
