...
IDENTIFIER = f"qrft_risk_model_test_mid"
ACTIVE_CF = 1.0
RISK_CF = 100.0
...
def test_picking(infer: pd.DataFrame, ddd):
    ...
    infer = infer.loc[:, infer.sum(0).sort_values(ascending=False).iloc[50:100].index]
    ...
    def negative_opt(w, factors, factor_stds):
        global RISK_CF
        ...
        return - (0*expected_return - RISK_CF*var)
    ...
    # )
    # if not opts.success:
    #     warnings.warn(f"{ddd}, optimal weight not optimized.")
    # weight = opts.x
...
comparison_dict = {
    ...
    "comparison_periods": [
        ("2001-01-31", "2021-05-31"),
        ("2009-01-31", "2021-05-31"),
        ("2013-01-31", "2021-05-31"),
        ("2019-01-31", "2021-05-31"),
    ],
