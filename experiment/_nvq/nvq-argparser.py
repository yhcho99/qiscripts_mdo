...
parser.add_argument('--intangible', type=float)

args = parser.parse_args()
ARGS_IDENTIFIER = args.identifier
ARGS_VALUE = args.value
ARGS_INTANGIBLE = args.intangible
...
path = DATA_DIR
setting_params = {
    "identifier": ARGS_IDENTIFIER ,  # 실험의 이름입니다
    "kirin_config": {
...
comparison_dict = {
    "performance_fps": [
        'test_nvq_value30_intangible70_1',
        'test_nvq_value30_intangible70_2',
        'test_nvq_value30_intangible70_3',
        'test_nvq_value40_intangible60_1',
        'test_nvq_value40_intangible60_2',
        'test_nvq_value40_intangible60_3',
        'test_nvq_value50_intangible50_1',
        'test_nvq_value50_intangible50_2',
        'test_nvq_value50_intangible50_3',
        'test_nvq_value60_intangible40_1',
        'test_nvq_value60_intangible40_2',
        'test_nvq_value60_intangible40_3',
        'test_nvq_value70_intangible30_1',
        'test_nvq_value70_intangible30_2',
        'test_nvq_value70_intangible30_3',
        
    ],  # identifier와 동일한 값 혹은, 전체 performance file paths
    "performance_names": [
        'test_nvq_value30_intangible70_1',
        'test_nvq_value30_intangible70_2',
        'test_nvq_value30_intangible70_3',
    ...
    "standard_benchmarks": ["U:SPY", "U:VTV"],  # 벤치마크로 삼을 U:SPY
...
#             qdata = qdata.rolling(_input_length).zsco test_re()
...
#     v = ARGS_VALUE * index_book_to_market + ARGS_INTANGIBLE * index_linear_intangible_to_tangible
