...
input_data = [
    ...
    #### (
    ####     "institutional_mfr",
    ####     ["high_level", "macro", "get_institutional_money_funds_rate"],
    #### ),
    ###("m1", ["high_level", "macro", "get_us_m1_rate"]),
    ###("m2", ["high_level", "macro", "get_us_m2_rate"]),
    #### ("mzm", ["high_level", "macro", "get_us_mzm_rate"]),
...
strategy_dict = {
    ...
    "long_weighting_config": (
        weights.rank_sum_discounted_mix_with_top_market_weight(0.995, 70, 300, 1.0),
    ),
...
if __name__ == "__main__":
    ...
    setting_params["identifier"] = identifier
    strategy_dict["long_weighting_config"][0]["active_num"] = num
    strategy_dict["long_weighting_config"][0]["weight"] = ratio
